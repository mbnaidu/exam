        ...
        return (
            ...
            <Navbar className="p-0 navbar-expand-lg " >
                ...
                <Nav Navbar className="pt-3 mr-4">
                    <NavLink className="navbar__link block-example" style={a} onMouseOver={()=>this.men()}   onMouseOut={()=>this.omen()}   exact activeClassName="navbar__link--active" className="navbar__link"to="/profile" >
                        PROFILE
                    </NavLink>
                    <NavLink activeClassName="navbar__link--active" style={b} onMouseOver={()=>this.women()} onMouseOut={()=>this.owomen()}  className="navbar__link" to="/exam">
                        EXAMS             
                    </NavLink>
                </Nav>
            </Navbar>
